...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('🎥 ️ᴍᴏᴠɪᴇs', url='https://t.me/Star_MoviesHub')
        ],[
            InlineKeyboardButton('💞ᴀʙᴏᴜᴛ ᴍᴇ💞', callback_data='about')
            ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await message.reply_chat_action("typing")
        m=await message.reply_sticker("CAACAgUAAxkBAAIfNWMDZqCSQl3G0yGZykrdVOfw9zPwAALEAgACv7T5V2Pjd2qPcg2kKQQ") 
    ...
    await client.send_cached_media(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton('⭕☞𝗠𝗔𝗜𝗡 𝗖𝗛𝗔𝗡𝗡𝗘𝗟⭕', url="https://t.me/Star_x_network")
                ],
                [
                    InlineKeyboardButton('⭕☞𝗠𝗢𝗩𝗜𝗘𝗦 𝗚𝗥𝗢𝗨𝗣⭕', url="https://t.me/Star_MoviesHub")
                ],
                [
                    InlineKeyboardButton('⭕☞𝗦𝗘𝗥𝗜𝗘𝗦 𝗖𝗛𝗔𝗡𝗡𝗘𝗟⭕', url="https://t.me/Star_X_Movies")
                ]
            ]
        )
    )
