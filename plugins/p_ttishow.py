...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        if message.chat.id in temp.BANNED_CHATS:
            ...
            buttons = [[
                InlineKeyboardButton('Support', url=f'https://t.me/Best_FriendsFor_Ever')
            ]]
        ...
        buttons = [[
            ...
            InlineKeyboardButton('📢 Updates', url='https://t.me/its_star_network')
        ]]
        reply_markup=InlineKeyboardMarkup(buttons)
